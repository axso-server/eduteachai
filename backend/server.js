...
app.post('/api/seed', async (req, res) => {
  try {
    ...
    if (adminExists) return res.json({ success: true, message: 'Mavjud' });
    await User.create({ name: 'Admin User', email: 'admin@edu.uz', password: 'admin123', role: 'admin' });
    ...
    res.json({ success: true, message: "Demo ma'lumotlar yaratildi!", credentials: [
